...
--
-- Host: localhost:3306
-- Generation Time: Sep 24, 2017 at 07:02 AM
...
--
-- Database: `u646731341_sptr`
--
CREATE DATABASE IF NOT EXISTS `u646731341_sptr` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `u646731341_sptr`;
...
('1990122420161224001', 'Teguh Pribadi', '57f9828927f21a664bc3755553a790b2', '1');
...
--
ALTER TABLE `presentasi`
  MODIFY `id_presentasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
--
-- AUTO_INCREMENT for table `tugasbesar`
--
ALTER TABLE `tugasbesar`
  MODIFY `id_tb` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;COMMIT;
