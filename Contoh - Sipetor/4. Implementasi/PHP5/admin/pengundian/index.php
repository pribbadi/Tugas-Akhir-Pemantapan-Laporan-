											...
											<div class="panel panel-default">
												...
												<div class="panel-body no-padding">
													<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
														...
														<tbody>
															<?php 
																$query = mysql_query("select * from presentasi where status='1'");
																$no=1;
																while ($dt=mysql_fetch_array($query)){?>
																	<tr>
																		...
																		<td>
																			<?php 
																				$nim=$dt['id_mahasiswa'];
																				$sqlmhs=mysql_query("select * from mahasiswa where id_mahasiswa='$nim'");
																				$ambilmhs=mysql_fetch_array($sqlmhs);
